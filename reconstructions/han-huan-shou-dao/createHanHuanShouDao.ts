...
export function createHanHuanShouDaoModel(options: ProceduralModelOptions = {}): THREE.Group {
  ...
  materialMap["hamon-steel"] = createSculptMaterial(
    "hamon-steel",
    {"id": "hamon-steel", "name": "Polished hamon line", "type": "standard", "shaderModel": "MeshStandardMaterial / PBR approximation", "baseColor": "#DDE1E4", "color": "#DDE1E4", "albedo": {"dominant": "#DDE1E4", "secondary": ["#C8CDD1", "#EEF0F2"], "samplingNotes": "Thin pale etched lines from the illustrated hamon band."}, "colorVariation": {"palette": ["#C8CDD1", "#DDE1E4", "#EEF0F2"], "pattern": "fine-etched-line", "amplitude": 0.04, "heightCorrelation": 0.0}, "textureResolution": 1024, "textureProjection": {"mode": "triplanar", "repeat": [4.0, 1.0], "anisotropy": 8, "texelDensityIntent": "Keep grind lines running heel-to-tip."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 1.2, "amplitude": 0.12, "role": "broad value along the hamon zone"}, {"id": "meso", "frequency": 8.0, "amplitude": 0.08, "role": "longitudinal grind"}, {"id": "micro", "frequency": 36.0, "amplitude": 0.04, "role": "fine polish grit"}], "roughness": {"base": 0.38, "variation": 0.05, "map": "independent-procedural-field"}, "metalness": {"base": 0.82, "variation": 0.06}, "envMapIntensity": 0.3, "vertexColors": false, "vertexToneFinal": false, "normal": {"pattern": "derived-from-independent-height-field", "strength": 0.14, "scale": 22.0, "space": "tangent"}, "bump": {"pattern": "longitudinal-grind", "amplitude": 0.002, "scale": 20.0}, "displacement": {"pattern": "none", "amplitude": 0.0, "scale": 1.0, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.18, "contactShadowBias": 0.2, "notes": "Keep the blade bright; only darken the guard and wrap contacts."}, "wear": {"edgeWear": 0.16, "scratches": ["faint heel-to-tip grind"], "chips": []}, "dirt": {"amount": 0.04, "cavityBias": 0.2, "color": "#6A6864"}, "patina": {"amount": 0.0, "color": "#AEB4BA", "notes": "Illustrated as clean steel."}, "localOverrides": [{"id": "hamon-band", "region": "wavy band along the edge, distal two-thirds", "albedo": "#D8DCE0", "roughness": 0.34, "notes": "Hamon is drawn, not a geometry bevel. Blockout keeps it as a value/roughness stain.", "evidenceRefs": ["blade-face"]}, {"id": "edge-brightening", "region": "cutting edge", "albedo": "#E8EBEE", "roughness": 0.2, "evidenceRefs": ["blade-face"]}], "shaderNotes": ["Polished steel: high metalness, mid-low roughness. Not rust, not chrome mirror.", "Do not reuse albedo as roughness."], "notes": "Reconstruct the three-view illustration, not the excavated relic photo."},
    options
  );
  ...
  socket_root_pommel_anchor_5.position.set(2.2036544811320757, 0.0, 0.0);
  socket_root_pommel_anchor_5.rotation.set(0.0, 0.0, 0.0);
  socket_root_pommel_anchor_5.userData.socket = {"id": "pommel-anchor", "localPosition": [2.2036544811320757, 0.0, 0.0], "localRotation": [0.0, 0.0, 0.0]};
  ...
  node_hamon_1_2.userData.sculptComponent = {"id": "hamon-1", "name": "Hamon front line 1", "level": "micro", "role": "detail", "importance": 0.72, "confidence": 0.78, "primitive": "tube", "topologyClass": "continuous-sculpt", "topologyRationale": "Thin procedural wave follows the blade front face rather than projecting source pixels.", "geometryDescriptor": {"topologyIntent": "Hamon front line 1 reconstruction", "edgeTreatment": {"type": "none", "bevelRadius": 0.0, "segments": 1}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry", "tubePath": {"points": [[0.30377, 0.00957, 0.0137], [0.35802, 0.00955, 0.01505], [0.41226, 0.00886, 0.0164], [0.46651, 0.00969, 0.01775], [0.54788, 0.00748, 0.0191], [0.62925, 0.00915, 0.02045], [0.73774, 0.00566, 0.0218], [0.87335, 0.01258, 0.0225], [1.03608, 0.01141, 0.0232], [1.22594, 0.00989, 0.02385], [1.4158, 0.0102, 0.02455], [1.61922, 0.01165, 0.0252]], "radius": 0.00075, "radialSegments": 6, "closed": false}}, "parent": "root", "attachment": {"parentId": "root", "parentSocket": "blade-heel", "localStart": [0.0, 0.0, 0.0], "localEnd": [0.0, 0.0, 0.0], "contactType": "sleeve", "overlap": 0.001, "gapTolerance": 0.004, "embedDepth": 0.0}, "dimensions": {"width": 1.0, "height": 1.0, "depth": 1.0, "units": "relative", "confidence": 0.78}, "transform": {"position": [0.0, 0.0, 0.0], "rotation": [0.0, 0.0, 0.0], "scale": [1.0, 1.0, 1.0]}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [], "collider": null, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "blade", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "hamon-steel"}}, "material": "hamon-steel", "materialLayers": ["hamon-steel"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0.28, "microRoughness": 0.18, "bumpAmplitude": 0.004, "normalPattern": "fine-grind-lines", "displacementPattern": "none", "occlusionPattern": "contact at fittings", "edgeWearPattern": "brighter steel at the cutting edge", "notes": "Orthographic illustration: polished steel, not excavated rust."}, "evidenceRefs": ["blade-face"], "details": [], "fidelityTier": "blockout", "colorMaterialRecipe": {"dominantAlbedo": "rgba(221, 225, 228, 1.0)", "secondaryAlbedo": "rgba(200, 205, 209, 1.0)", "materialClass": "metal", "materialClassConfidence": 0.72}, "explodeWithParent": "blade", "ownerModule": "blade", "face": "front", "mergePolicy": "bake"};
  ...
  const mesh_hamon_1_2Geometry = endpoint_hamon_1_2
    ...
    : buildTubeGeometry({"points": [[0.30377, 0.00957, 0.0137], [0.35802, 0.00955, 0.01505], [0.41226, 0.00886, 0.0164], [0.46651, 0.00969, 0.01775], [0.54788, 0.00748, 0.0191], [0.62925, 0.00915, 0.02045], [0.73774, 0.00566, 0.0218], [0.87335, 0.01258, 0.0225], [1.03608, 0.01141, 0.0232], [1.22594, 0.00989, 0.02385], [1.4158, 0.0102, 0.02455], [1.61922, 0.01165, 0.0252]], "radius": 0.00075, "radialSegments": 6, "closed": false});
  if (!endpoint_hamon_1_2) {
  ...
  node_hamon_2_3.userData.sculptComponent = {"id": "hamon-2", "name": "Hamon front line 2", "level": "micro", "role": "detail", "importance": 0.72, "confidence": 0.78, "primitive": "tube", "topologyClass": "continuous-sculpt", "topologyRationale": "Thin procedural wave follows the blade front face rather than projecting source pixels.", "geometryDescriptor": {"topologyIntent": "Hamon front line 2 reconstruction", "edgeTreatment": {"type": "none", "bevelRadius": 0.0, "segments": 1}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry", "tubePath": {"points": [[0.30377, 0.01557, 0.0137], [0.35802, 0.01557, 0.01505], [0.41226, 0.01493, 0.0164], [0.46651, 0.01556, 0.01775], [0.54788, 0.01371, 0.0191], [0.62925, 0.01575, 0.02045], [0.73774, 0.01161, 0.0218], [0.87335, 0.01655, 0.0225], [1.03608, 0.01908, 0.0232], [1.22594, 0.01764, 0.02385], [1.4158, 0.0171, 0.02455], [1.61922, 0.01772, 0.0252]], "radius": 0.0011, "radialSegments": 6, "closed": false}}, "parent": "root", "attachment": {"parentId": "root", "parentSocket": "blade-heel", "localStart": [0.0, 0.0, 0.0], "localEnd": [0.0, 0.0, 0.0], "contactType": "sleeve", "overlap": 0.001, "gapTolerance": 0.004, "embedDepth": 0.0}, "dimensions": {"width": 1.0, "height": 1.0, "depth": 1.0, "units": "relative", "confidence": 0.78}, "transform": {"position": [0.0, 0.0, 0.0], "rotation": [0.0, 0.0, 0.0], "scale": [1.0, 1.0, 1.0]}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [], "collider": null, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "blade", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "hamon-steel"}}, "material": "hamon-steel", "materialLayers": ["hamon-steel"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0.28, "microRoughness": 0.18, "bumpAmplitude": 0.004, "normalPattern": "fine-grind-lines", "displacementPattern": "none", "occlusionPattern": "contact at fittings", "edgeWearPattern": "brighter steel at the cutting edge", "notes": "Orthographic illustration: polished steel, not excavated rust."}, "evidenceRefs": ["blade-face"], "details": [], "fidelityTier": "blockout", "colorMaterialRecipe": {"dominantAlbedo": "rgba(221, 225, 228, 1.0)", "secondaryAlbedo": "rgba(200, 205, 209, 1.0)", "materialClass": "metal", "materialClassConfidence": 0.72}, "explodeWithParent": "blade", "ownerModule": "blade", "face": "front", "mergePolicy": "bake"};
  ...
  const mesh_hamon_2_3Geometry = endpoint_hamon_2_3
    ...
    : buildTubeGeometry({"points": [[0.30377, 0.01557, 0.0137], [0.35802, 0.01557, 0.01505], [0.41226, 0.01493, 0.0164], [0.46651, 0.01556, 0.01775], [0.54788, 0.01371, 0.0191], [0.62925, 0.01575, 0.02045], [0.73774, 0.01161, 0.0218], [0.87335, 0.01655, 0.0225], [1.03608, 0.01908, 0.0232], [1.22594, 0.01764, 0.02385], [1.4158, 0.0171, 0.02455], [1.61922, 0.01772, 0.0252]], "radius": 0.0011, "radialSegments": 6, "closed": false});
  if (!endpoint_hamon_2_3) {
  ...
  node_hamon_3_4.userData.sculptComponent = {"id": "hamon-3", "name": "Hamon front line 3", "level": "micro", "role": "detail", "importance": 0.72, "confidence": 0.78, "primitive": "tube", "topologyClass": "continuous-sculpt", "topologyRationale": "Thin procedural wave follows the blade front face rather than projecting source pixels.", "geometryDescriptor": {"topologyIntent": "Hamon front line 3 reconstruction", "edgeTreatment": {"type": "none", "bevelRadius": 0.0, "segments": 1}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry", "tubePath": {"points": [[0.30377, 0.02157, 0.0137], [0.35802, 0.02162, 0.01505], [0.41226, 0.0209, 0.0164], [0.46651, 0.0213, 0.01775], [0.54788, 0.02042, 0.0191], [0.62925, 0.02169, 0.02045], [0.73774, 0.0189, 0.0218], [0.87335, 0.01968, 0.0225], [1.03608, 0.02465, 0.0232], [1.22594, 0.02394, 0.02385], [1.4158, 0.02345, 0.02455], [1.61922, 0.02374, 0.0252]], "radius": 0.00075, "radialSegments": 6, "closed": false}}, "parent": "root", "attachment": {"parentId": "root", "parentSocket": "blade-heel", "localStart": [0.0, 0.0, 0.0], "localEnd": [0.0, 0.0, 0.0], "contactType": "sleeve", "overlap": 0.001, "gapTolerance": 0.004, "embedDepth": 0.0}, "dimensions": {"width": 1.0, "height": 1.0, "depth": 1.0, "units": "relative", "confidence": 0.78}, "transform": {"position": [0.0, 0.0, 0.0], "rotation": [0.0, 0.0, 0.0], "scale": [1.0, 1.0, 1.0]}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [], "collider": null, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "blade", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "hamon-steel"}}, "material": "hamon-steel", "materialLayers": ["hamon-steel"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0.28, "microRoughness": 0.18, "bumpAmplitude": 0.004, "normalPattern": "fine-grind-lines", "displacementPattern": "none", "occlusionPattern": "contact at fittings", "edgeWearPattern": "brighter steel at the cutting edge", "notes": "Orthographic illustration: polished steel, not excavated rust."}, "evidenceRefs": ["blade-face"], "details": [], "fidelityTier": "blockout", "colorMaterialRecipe": {"dominantAlbedo": "rgba(221, 225, 228, 1.0)", "secondaryAlbedo": "rgba(200, 205, 209, 1.0)", "materialClass": "metal", "materialClassConfidence": 0.72}, "explodeWithParent": "blade", "ownerModule": "blade", "face": "front", "mergePolicy": "bake"};
  ...
  const mesh_hamon_3_4Geometry = endpoint_hamon_3_4
    ...
    : buildTubeGeometry({"points": [[0.30377, 0.02157, 0.0137], [0.35802, 0.02162, 0.01505], [0.41226, 0.0209, 0.0164], [0.46651, 0.0213, 0.01775], [0.54788, 0.02042, 0.0191], [0.62925, 0.02169, 0.02045], [0.73774, 0.0189, 0.0218], [0.87335, 0.01968, 0.0225], [1.03608, 0.02465, 0.0232], [1.22594, 0.02394, 0.02385], [1.4158, 0.02345, 0.02455], [1.61922, 0.02374, 0.0252]], "radius": 0.00075, "radialSegments": 6, "closed": false});
  if (!endpoint_hamon_3_4) {
  ...
  node_hamon_back_1_5.userData.sculptComponent = {"id": "hamon-back-1", "name": "Hamon back line 1", "level": "micro", "role": "detail", "importance": 0.72, "confidence": 0.68, "primitive": "tube", "topologyClass": "continuous-sculpt", "topologyRationale": "Thin procedural wave follows the blade back face rather than projecting source pixels.", "geometryDescriptor": {"topologyIntent": "Hamon back line 1 reconstruction", "edgeTreatment": {"type": "none", "bevelRadius": 0.0, "segments": 1}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry", "tubePath": {"points": [[0.30377, 0.00957, -0.0137], [0.35802, 0.00956, -0.01505], [0.41226, 0.0089, -0.0164], [0.46651, 0.00965, -0.01775], [0.54788, 0.00752, -0.0191], [0.62925, 0.0095, -0.02045], [0.73774, 0.00546, -0.0218], [0.87335, 0.01183, -0.0225], [1.03608, 0.01242, -0.0232], [1.22594, 0.01083, -0.02385], [1.4158, 0.01065, -0.02455], [1.61922, 0.01169, -0.0252]], "radius": 0.00075, "radialSegments": 6, "closed": false}}, "parent": "root", "attachment": {"parentId": "root", "parentSocket": "blade-heel", "localStart": [0.0, 0.0, 0.0], "localEnd": [0.0, 0.0, 0.0], "contactType": "sleeve", "overlap": 0.001, "gapTolerance": 0.004, "embedDepth": 0.0}, "dimensions": {"width": 1.0, "height": 1.0, "depth": 1.0, "units": "relative", "confidence": 0.68}, "transform": {"position": [0.0, 0.0, 0.0], "rotation": [0.0, 0.0, 0.0], "scale": [1.0, 1.0, 1.0]}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [], "collider": null, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "blade", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "hamon-steel"}}, "material": "hamon-steel", "materialLayers": ["hamon-steel"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0.28, "microRoughness": 0.18, "bumpAmplitude": 0.004, "normalPattern": "fine-grind-lines", "displacementPattern": "none", "occlusionPattern": "contact at fittings", "edgeWearPattern": "brighter steel at the cutting edge", "notes": "Orthographic illustration: polished steel, not excavated rust."}, "evidenceRefs": ["blade-face"], "details": [], "fidelityTier": "blockout", "colorMaterialRecipe": {"dominantAlbedo": "rgba(221, 225, 228, 1.0)", "secondaryAlbedo": "rgba(200, 205, 209, 1.0)", "materialClass": "metal", "materialClassConfidence": 0.72}, "explodeWithParent": "blade", "ownerModule": "blade", "face": "back", "mergePolicy": "bake"};
  ...
  const mesh_hamon_back_1_5Geometry = endpoint_hamon_back_1_5
    ...
    : buildTubeGeometry({"points": [[0.30377, 0.00957, -0.0137], [0.35802, 0.00956, -0.01505], [0.41226, 0.0089, -0.0164], [0.46651, 0.00965, -0.01775], [0.54788, 0.00752, -0.0191], [0.62925, 0.0095, -0.02045], [0.73774, 0.00546, -0.0218], [0.87335, 0.01183, -0.0225], [1.03608, 0.01242, -0.0232], [1.22594, 0.01083, -0.02385], [1.4158, 0.01065, -0.02455], [1.61922, 0.01169, -0.0252]], "radius": 0.00075, "radialSegments": 6, "closed": false});
  if (!endpoint_hamon_back_1_5) {
  ...
  node_hamon_back_2_6.userData.sculptComponent = {"id": "hamon-back-2", "name": "Hamon back line 2", "level": "micro", "role": "detail", "importance": 0.72, "confidence": 0.68, "primitive": "tube", "topologyClass": "continuous-sculpt", "topologyRationale": "Thin procedural wave follows the blade back face rather than projecting source pixels.", "geometryDescriptor": {"topologyIntent": "Hamon back line 2 reconstruction", "edgeTreatment": {"type": "none", "bevelRadius": 0.0, "segments": 1}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry", "tubePath": {"points": [[0.30377, 0.01557, -0.0137], [0.35802, 0.01559, -0.01505], [0.41226, 0.01493, -0.0164], [0.46651, 0.01545, -0.01775], [0.54788, 0.014, -0.0191], [0.62925, 0.01581, -0.02045], [0.73774, 0.01206, -0.0218], [0.87335, 0.01524, -0.0225], [1.03608, 0.01915, -0.0232], [1.22594, 0.01799, -0.02385], [1.4158, 0.01735, -0.02455], [1.61922, 0.01774, -0.0252]], "radius": 0.0011, "radialSegments": 6, "closed": false}}, "parent": "root", "attachment": {"parentId": "root", "parentSocket": "blade-heel", "localStart": [0.0, 0.0, 0.0], "localEnd": [0.0, 0.0, 0.0], "contactType": "sleeve", "overlap": 0.001, "gapTolerance": 0.004, "embedDepth": 0.0}, "dimensions": {"width": 1.0, "height": 1.0, "depth": 1.0, "units": "relative", "confidence": 0.68}, "transform": {"position": [0.0, 0.0, 0.0], "rotation": [0.0, 0.0, 0.0], "scale": [1.0, 1.0, 1.0]}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [], "collider": null, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "blade", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "hamon-steel"}}, "material": "hamon-steel", "materialLayers": ["hamon-steel"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0.28, "microRoughness": 0.18, "bumpAmplitude": 0.004, "normalPattern": "fine-grind-lines", "displacementPattern": "none", "occlusionPattern": "contact at fittings", "edgeWearPattern": "brighter steel at the cutting edge", "notes": "Orthographic illustration: polished steel, not excavated rust."}, "evidenceRefs": ["blade-face"], "details": [], "fidelityTier": "blockout", "colorMaterialRecipe": {"dominantAlbedo": "rgba(221, 225, 228, 1.0)", "secondaryAlbedo": "rgba(200, 205, 209, 1.0)", "materialClass": "metal", "materialClassConfidence": 0.72}, "explodeWithParent": "blade", "ownerModule": "blade", "face": "back", "mergePolicy": "bake"};
  ...
  const mesh_hamon_back_2_6Geometry = endpoint_hamon_back_2_6
    ...
    : buildTubeGeometry({"points": [[0.30377, 0.01557, -0.0137], [0.35802, 0.01559, -0.01505], [0.41226, 0.01493, -0.0164], [0.46651, 0.01545, -0.01775], [0.54788, 0.014, -0.0191], [0.62925, 0.01581, -0.02045], [0.73774, 0.01206, -0.0218], [0.87335, 0.01524, -0.0225], [1.03608, 0.01915, -0.0232], [1.22594, 0.01799, -0.02385], [1.4158, 0.01735, -0.02455], [1.61922, 0.01774, -0.0252]], "radius": 0.0011, "radialSegments": 6, "closed": false});
  if (!endpoint_hamon_back_2_6) {
  ...
  node_hamon_back_3_7.userData.sculptComponent = {"id": "hamon-back-3", "name": "Hamon back line 3", "level": "micro", "role": "detail", "importance": 0.72, "confidence": 0.68, "primitive": "tube", "topologyClass": "continuous-sculpt", "topologyRationale": "Thin procedural wave follows the blade back face rather than projecting source pixels.", "geometryDescriptor": {"topologyIntent": "Hamon back line 3 reconstruction", "edgeTreatment": {"type": "none", "bevelRadius": 0.0, "segments": 1}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry", "tubePath": {"points": [[0.30377, 0.02157, -0.0137], [0.35802, 0.02164, -0.01505], [0.41226, 0.02085, -0.0164], [0.46651, 0.02119, -0.01775], [0.54788, 0.02081, -0.0191], [0.62925, 0.02145, -0.02045], [0.73774, 0.0198, -0.0218], [0.87335, 0.01848, -0.0225], [1.03608, 0.0238, -0.0232], [1.22594, 0.02351, -0.02385], [1.4158, 0.02334, -0.02455], [1.61922, 0.02373, -0.0252]], "radius": 0.00075, "radialSegments": 6, "closed": false}}, "parent": "root", "attachment": {"parentId": "root", "parentSocket": "blade-heel", "localStart": [0.0, 0.0, 0.0], "localEnd": [0.0, 0.0, 0.0], "contactType": "sleeve", "overlap": 0.001, "gapTolerance": 0.004, "embedDepth": 0.0}, "dimensions": {"width": 1.0, "height": 1.0, "depth": 1.0, "units": "relative", "confidence": 0.68}, "transform": {"position": [0.0, 0.0, 0.0], "rotation": [0.0, 0.0, 0.0], "scale": [1.0, 1.0, 1.0]}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [], "collider": null, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "blade", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "hamon-steel"}}, "material": "hamon-steel", "materialLayers": ["hamon-steel"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0.28, "microRoughness": 0.18, "bumpAmplitude": 0.004, "normalPattern": "fine-grind-lines", "displacementPattern": "none", "occlusionPattern": "contact at fittings", "edgeWearPattern": "brighter steel at the cutting edge", "notes": "Orthographic illustration: polished steel, not excavated rust."}, "evidenceRefs": ["blade-face"], "details": [], "fidelityTier": "blockout", "colorMaterialRecipe": {"dominantAlbedo": "rgba(221, 225, 228, 1.0)", "secondaryAlbedo": "rgba(200, 205, 209, 1.0)", "materialClass": "metal", "materialClassConfidence": 0.72}, "explodeWithParent": "blade", "ownerModule": "blade", "face": "back", "mergePolicy": "bake"};
  ...
  const mesh_hamon_back_3_7Geometry = endpoint_hamon_back_3_7
    ...
    : buildTubeGeometry({"points": [[0.30377, 0.02157, -0.0137], [0.35802, 0.02164, -0.01505], [0.41226, 0.02085, -0.0164], [0.46651, 0.02119, -0.01775], [0.54788, 0.02081, -0.0191], [0.62925, 0.02145, -0.02045], [0.73774, 0.0198, -0.0218], [0.87335, 0.01848, -0.0225], [1.03608, 0.0238, -0.0232], [1.22594, 0.02351, -0.02385], [1.4158, 0.02334, -0.02455], [1.61922, 0.02373, -0.0252]], "radius": 0.00075, "radialSegments": 6, "closed": false});
  if (!endpoint_hamon_back_3_7) {
  ...
  const mesh_ring_39Geometry = endpoint_ring_39
    ...
    : buildExtrudeGeometry({"points": [[-0.35, -0.5], [0.35, -0.5], [0.48, -0.38], [0.5, -0.2], [0.5, 0.2], [0.48, 0.38], [0.35, 0.5], [-0.35, 0.5], [-0.48, 0.38], [-0.5, 0.2], [-0.5, -0.2], [-0.48, -0.38]], "depth": 1.0, "ovalHoles": [{"cx": 0.03, "cy": 0.01, "rx": 0.26, "ry": 0.41}]});
  if (!endpoint_ring_39) {
    mesh_ring_39Geometry.scale(0.156, 0.139, 0.012);
  }
  ...
  node_ring_engraving_outer_40.userData.sculptComponent = {"id": "ring-engraving-outer", "name": "Ring engraving outer", "level": "micro", "role": "detail", "importance": 0.68, "confidence": 0.74, "primitive": "tube", "topologyClass": "continuous-sculpt", "topologyRationale": "Closed dark line follows the ring front face as shallow engraved relief.", "geometryDescriptor": {"topologyIntent": "Ring engraving outer reconstruction", "edgeTreatment": {"type": "none", "bevelRadius": 0.0, "segments": 1}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "vertex normals from generated geometry", "tubePath": {"points": [[2.15615, -0.06047, 0.0067], [2.25116, -0.06047, 0.0067], [2.2688, -0.04595, 0.0067], [2.27151, -0.02419, 0.0067], [2.27151, 0.02419, 0.0067], [2.2688, 0.04595, 0.0067], [2.25116, 0.06047, 0.0067], [2.15615, 0.06047, 0.0067], [2.13851, 0.04595, 0.0067], [2.13579, 0.02419, 0.0067], [2.13579, -0.02419, 0.0067], [2.13851, -0.04595, 0.0067]], "radius": 0.0011, "radialSegments": 6, "closed": true}}, "parent": "root", "attachment": {"parentId": "root", "parentSocket": "pommel-anchor", "localStart": [0.0, 0.0, 0.0], "localEnd": [0.0, 0.0, 0.0], "contactType": "sleeve", "overlap": 0.001, "gapTolerance": 0.004, "embedDepth": 0.0}, "dimensions": {"width": 1.0, "height": 1.0, "depth": 1.0, "units": "relative", "confidence": 0.74}, "transform": {"position": [0.0, 0.0, 0.0], "rotation": [0.0, 0.0, 0.0], "scale": [1.0, 1.0, 1.0]}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [], "collider": null, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "ring", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "gilt-engraving"}}, "material": "gilt-engraving", "materialLayers": ["gilt-engraving"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0.28, "microRoughness": 0.18, "bumpAmplitude": 0.004, "normalPattern": "fine-grind-lines", "displacementPattern": "none", "occlusionPattern": "contact at fittings", "edgeWearPattern": "brighter steel at the cutting edge", "notes": "Orthographic illustration: polished steel, not excavated rust."}, "evidenceRefs": ["pommel-ring"], "details": [], "fidelityTier": "blockout", "colorMaterialRecipe": {"dominantAlbedo": "rgba(111, 84, 39, 1.0)", "secondaryAlbedo": "rgba(79, 57, 26, 1.0)", "materialClass": "metal", "materialClassConfidence": 0.7}, "explodeWithParent": "ring", "ownerModule": "ring", "face": "front", "mergePolicy": "bake"};
  ...
  const mesh_ring_engraving_outer_40Geometry = endpoint_ring_engraving_outer_40
    ...
    : buildTubeGeometry({"points": [[2.15615, -0.06047, 0.0067], [2.25116, -0.06047, 0.0067], [2.2688, -0.04595, 0.0067], [2.27151, -0.02419, 0.0067], [2.27151, 0.02419, 0.0067], [2.2688, 0.04595, 0.0067], [2.25116, 0.06047, 0.0067], [2.15615, 0.06047, 0.0067], [2.13851, 0.04595, 0.0067], [2.13579, 0.02419, 0.0067], [2.13579, -0.02419, 0.0067], [2.13851, -0.04595, 0.0067]], "radius": 0.0011, "radialSegments": 6, "closed": true});
  if (!endpoint_ring_engraving_outer_40) {
  ...
  node_ring_engraving_middle_41.userData.sculptComponent = {"id": "ring-engraving-middle", "name": "Ring engraving middle", "level": "micro", "role": "detail", "importance": 0.68, "confidence": 0.74, "primitive": "tube", "topologyClass": "continuous-sculpt", "topologyRationale": "
 0.0067]], "radius": 0.0011, "radialSegments": 6, "closed": true}}, "parent": "root", "attachment": {"parentId": "root", "parentSocket": "pommel-anchor", "localStart": [0.0, 0.0, 0.0], "localEnd": [0.0, 0.0, 0.0], "contactType": "sleeve", "overlap": 0.001, "gapTolerance": 0.004, "embedDepth": 0.0}, "dimensions": {"width": 1.0, "height": 1.0, "depth": 1.0, "units": "relative", "confidence": 0.74}, "transform": {"position": [0.0, 0.0, 0.0], "rotation": [0.0, 0.0, 0.0], "scale": [1.0, 1.0, 1.0]}, "actionProfile": {"animationRole": "static", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.7}, "transformChannels": {"translate": true, "rotate": true, "scale": true, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [], "collider": null, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "ring", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0.0, "debrisMaterial": "gilt-engraving"}}, "material": "gilt-engraving", "materialLayers": ["gilt-engraving"], "deformations": [], "joints": [], "seams": [], "localFeatures": [], "surfaceDetail": {"macroRoughness": 0.28, "microRoughness": 0.18, "bumpAmplitude": 0.004, "normalPattern": "fine-grind-lines", "displacementPattern": "none", "occlusionPattern": "contact at fittings", "edgeWearPattern": "brighter steel at the cutting edge", "notes": "Orthographic illustration: polished steel, not excavated rust."}, "evidenceRefs": ["pommel-ring"], "details": [], "fidelityTier": "blockout", "colorMaterialRecipe": {"dominantAlbedo": "rgba(111, 84, 39, 1.0)", "secondaryAlbedo": "rgba(79, 57, 26, 1.0)", "materialClass": "metal", "materialClassConfidence": 0.7}, "explodeWithParent": "ring", "ownerModule": "ring", "face": "front", "mergePolicy": "bake"};
  ...
  const mesh_ring_engraving_inner_42Geometry = endpoint_ring_engraving_inner_42
    ...
    : buildTubeGeometry({"points": [[2.25513, 0.00139, 0.0067], [2.25473, 0.00937, 0.0067], [2.25354, 0.01722, 0.0067], [2.25157, 0.02479, 0.0067], [2.24886, 0.03197, 0.0067], [2.24546, 0.03862, 0.0067], [2.24143, 0.04464, 0.0067], [2.23682, 0.04991, 0.0067], [2.23173, 0.05436, 0.0067], [2.22624, 0.05789, 0.0067], [2.22045, 0.06047, 0.0067], [2.21444, 0.06203, 0.0067], [2.20833, 0.06255, 0.0067], [2.20223, 0.06203, 0.0067], [2.19622, 0.06047, 0.0067], [2.19042, 0.05789, 0.0067], [2.18493, 0.05436, 0.0067], [2.17984, 0.04991, 0.0067], [2.17524, 0.04464, 0.0067], [2.17121, 0.03862, 0.0067], [2.1678, 0.03197, 0.0067], [2.1651, 0.02479, 0.0067], [2.16313, 0.01722, 0.0067], [2.16193, 0.00937, 0.0067], [2.16153, 0.00139, 0.0067], [2.16193, -0.00659, 0.0067], [2.16313, -0.01444, 0.0067], [2.1651, -0.02201, 0.0067], [2.1678, -0.02919, 0.0067], [2.17121, -0.03584, 0.0067], [2.17524, -0.04186, 0.0067], [2.17984, -0.04713, 0.0067], [2.18493, -0.05158, 0.0067], [2.19042, -0.05511, 0.0067], [2.19622, -0.05769, 0.0067], [2.20223, -0.05925, 0.0067], [2.20833, -0.05977, 0.0067], [2.21444, -0.05925, 0.0067], [2.22045, -0.05769, 0.0067], [2.22624, -0.05511, 0.0067], [2.23173, -0.05158, 0.0067], [2.23682, -0.04713, 0.0067], [2.24143, -0.04186, 0.0067], [2.24546, -0.03584, 0.0067], [2.24886, -0.02919, 0.0067], [2.25157, -0.02201, 0.0067], [2.25354, -0.01444, 0.0067], [2.25473, -0.00659, 0.0067]], "radius": 0.0011, "radialSegments": 6, "closed": true});
  if (!endpoint_ring_engraving_inner_42) {
